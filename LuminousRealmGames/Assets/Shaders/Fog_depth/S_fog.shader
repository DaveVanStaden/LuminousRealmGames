	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float4 screenPos10 = input.ase_texcoord4;
				...
				float2 uv_alpha_texture = input.ase_texcoord5.xy * _alpha_texture_ST.xy + _alpha_texture_ST.zw;
				...
				float3 Color = ( _color + ( distanceDepth10 + tex2D( _albedo, uv_albedo ) ) ).rgb;
				float Alpha = 1;
...
ASEEND*/
//CHKSM=AD2E3D06706E3A841BF55E93F51CE7F0D99F01E5